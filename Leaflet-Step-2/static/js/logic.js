...
// call the api to get the info for the techtonic plates
...
.then(
        function(earthquakeData){
            ...
            //plot circles, where the readius is dependent on the magnitude
            ...
            //make a function that determines the size of the radious
...
//add the overlays for the tectonic plates and for the earthquakes
let overlays = {
...
legend.onAdd = function(){
    ...
    //loop through the intevals and the colors and generate a label
    //with a colored square for each interval
    for (var i=0; i< intervals.length; i++)
    {
        //inner html sets the square for each interval and label
